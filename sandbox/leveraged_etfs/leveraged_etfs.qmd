...
# Yahoo occasionally serves a session with no close; drop those rows rather than
# fail, but stop if they are more than a negligible share of the series.
stopifnot(cl2[, mean(is.na(`CL2.PA.Close`))] < 0.01)
cl2 <- cl2[!is.na(`CL2.PA.Close`)]
